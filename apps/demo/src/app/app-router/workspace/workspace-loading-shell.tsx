...
export function WorkspaceLoadingShell() {
  return (
    <div
      data-testid="app-router-workspace-shell"
      aria-label="Loading App Router workspace"
      className="flex h-screen overflow-hidden bg-background text-foreground"
    >
      <aside className="hidden w-60 shrink-0 flex-col border-r border-border bg-sidebar md:flex">
        <div className="flex h-14 items-center gap-2 px-4">
          <span className="flex size-6 items-center justify-center rounded-md bg-cobalt text-xs font-bold text-primary-foreground">
            A
          </span>
