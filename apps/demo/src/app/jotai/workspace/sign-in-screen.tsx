...
import { signInAtom } from "@/app/jotai/api/atoms";
import { useCurrentUser } from "@/app/jotai/api/hooks";
import { Avatar } from "@/components/ui/avatar";
import { Button } from "@/components/ui/button";

export function SignInScreen() {
  // Still served from the read the workspace already made — signing back in is
  // what bumps the session epoch and moves every scope, this one included, onto
  // fresh data.
