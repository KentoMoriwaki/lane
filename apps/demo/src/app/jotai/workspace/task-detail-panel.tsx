...
/**
 * The panel reads the selection rather than receiving an id: `selectedTaskAtom`
 * is "the task the workspace has open", so clearing the selection resolves it
 * to null in the same write instead of leaving a read pointed at a task that is
 * on its way out.
 */
