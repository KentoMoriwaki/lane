...
import type { TaskFilters } from "@/app/react-query-rsc/api/endpoints";
import { useLabels, useProjects, useTasks } from "@/app/react-query-rsc/api/hooks";
...
export function FilterBar({
  ...
  const { data: tasks, isFetching, isPlaceholderData } = useTasks(filters);
