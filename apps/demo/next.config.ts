...
const nextConfig: NextConfig = {
  ...
  // links fetch that shared shell without resolving URL-dependent data. Runtime
  // prefetching is deliberately absent: it can only resolve static or cached
  // reads, and this workspace reads its API on every render.
